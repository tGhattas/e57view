...
export const __wbg_meshdistance_free: (a: number, b: number) => void;
export const __wbg_pointsink_free: (a: number, b: number) => void;
export const cloudanalysis_add_leaf: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => void;
...
export const cloudanalysis_distance_to_mesh: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number];
...
export const cloudanalysis_feature: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number];
...
export const cloudanalysis_noise: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number];
...
export const cloudanalysis_sor_cut: (a: number, b: number, c: number, d: number, e: number) => [number, number];
export const cloudanalysis_sor_means: (a: number, b: number, c: number, d: number) => [number, number];
export const cloudanalysis_sor_stats: (a: number, b: number, c: number, d: number) => [number, number];
...
export const meshdistance_distances: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
export const meshdistance_new: (a: number, b: number, c: number, d: number) => [number, number, number];
